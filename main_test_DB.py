...
def main():
    ...
    #try to drop the table then recreate them
    try:
    ...
    try:
        ...
        try:
            Connector.execute(open('Sql/update_tables_after_faker.sql', 'r').read())   #update data to make them correct after the faker insert.
            Connector.commit()
        except Exception as e:
            print(f"Error: {e}") 
